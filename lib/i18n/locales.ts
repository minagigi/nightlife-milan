...
export const LOCALES: LocaleDef[] = [
  ...
  // ——— Tier A ———
  { code: 'es', country: 'es', hreflang: 'es', nativeName: 'Español', englishName: 'Spanish', dir: 'ltr', tier: 'A', ebLocale: 'es_ES', ogLocale: 'es_ES', group: 'west', enabled: true, indexed: false },
  { code: 'fr', country: 'fr', hreflang: 'fr', nativeName: 'Français', englishName: 'French', dir: 'ltr', tier: 'A', ebLocale: 'fr_FR', ogLocale: 'fr_FR', group: 'west', enabled: true, indexed: false },
  { code: 'de', country: 'de', hreflang: 'de', nativeName: 'Deutsch', englishName: 'German', dir: 'ltr', tier: 'A', ebLocale: 'de_DE', ogLocale: 'de_DE', group: 'west', enabled: true, indexed: false },
  { code: 'pt', country: 'pt', hreflang: 'pt', nativeName: 'Português', englishName: 'Portuguese', dir: 'ltr', tier: 'A', ebLocale: 'pt_PT', ogLocale: 'pt_PT', group: 'west', enabled: true, indexed: false },
