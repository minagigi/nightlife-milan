...
export default function Hero({ locale }: { locale: string }) {
  ...
  }, [featuredVenues.length, isPaused]);
  ...
  const current = featuredVenues[currentIndex];

  return (
    <section
      className="relative w-full h-[100svh] min-h-[560px] max-h-[900px] overflow-hidden bg-black flex items-end"
    ...
    >
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 w-[60%] h-[50%] pointer-events-none"
        style={{
          background: 'radial-gradient(ellipse at bottom left, rgba(201,168,106,0.22) 0%, transparent 70%)',
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 sm:px-10 pb-14 sm:pb-20">
        ...
        {/* Venue name — big editorial headline */}
          ...
          <AnimatePresence mode="wait">
            <motion.h1
              ...
              style={{
                ...
                textShadow: '0 0 60px rgba(201,168,106,0.3)',
              }}
            >
        ...
        <div className="flex items-center mt-7 -ml-2">
          ...
          <span className="ml-2 font-sans text-white/30 text-[10px] tracking-widest">
            {String(currentIndex + 1).padStart(2, '0')} / {String(featuredVenues.length).padStart(2, '0')}
          </span>
        </div>
      </div>
