...
- Scheduled the protected sitemap-only Search Console submission for the canonical domain property once daily at 18:00 UTC; the 08:00 Eventbrite refresh no longer uses the Google Indexing API or submits the sitemap.
