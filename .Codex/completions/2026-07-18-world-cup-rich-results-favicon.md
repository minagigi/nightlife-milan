...
- Verification: typecheck, lint, 65 tests, production build (305 static pages), 35/35 locale crawl, 6/6 sitemap URLs, JSON-LD inspection, favicon responses, global-host redirect tests, and independent Deep review (`RELEASE`).
